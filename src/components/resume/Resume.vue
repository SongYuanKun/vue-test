      ...
      <div class="container">
        ...
        <header>
          ...
          <div class="header-bottom-agileits">
            <div class="w3-logo">
              <h1><a href="index.html">Apt Resume<span class="sub-logo">Apt Resume</span></a></h1>
            </div>
            <!-- navigation -->
        ...
        <div class="banner-text-w3-agileits">
          <h5>Hi, I'm</h5>
          <h2><span>S</span>teve <span>M</span>artin</h2>
          <p>Web Designer & Director</p>
          <div class="botton">
            <a href="#about" class="scroll">About me <span class="fa fa-caret-right"></span></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="tittle-agileinfo">
          ...
          <div class="about-top">
            ...
            <p class="para-agileits-w3layouts">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer quis
          ...
          <div class="scrollbar agileits w3layouts" id="style-2">
            <div class="activity-row agileits w3layouts">
              ...
              <div class="activity-desc agileits w3layouts">
                ...
                <p class="para-agileits-w3layouts">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque
                  nec congue risus. In non nulla lacus. Maecenas
        ...
        <div class="activity_box agileits w3layouts">
          ...
          <div class="scrollbar agileits w3layouts" id="style-1">
            ...
            <div class="activity-row agileits w3layouts">
              ...
              <div class="activity-desc agileits w3layouts">
                <h5>Sitamet</h5>
                <p class="para-agileits-w3layouts">Lorem Ipsum is simply dummy text of the printing and typesetting
                  industry.</p>
              </div>
              <div class="clearfix"></div>
            </div>
    ...
    <div class="language-skills">
      <div class="container">
        <div class="col-md-6 lang-left-w3-agile">
          ...
          <p class="para-agileits-w3layouts">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nec
            congue risus. In non nulla lacus. Maecenas
            eros sapien, eleifend quis augue eu, pellentesque tincidunt tellus</p>
        </div>
        <div class="col-md-6 w3l_about_bottom_grid_right bar-grids">
          <h6>English<span> 100% </span></h6>
          <div class="progress">
            <div class="progress-bar progress-bar-striped active" style="width: 100%">
            </div>
          </div>
          <div class="mid-bar">
            <h6>Dutch<span> 85% </span></h6>
            <div class="progress">
              <div class="progress-bar progress-bar-striped active" style="width: 85%">
              </div>
            </div>
          </div>
          <h6>Hindi<span>67% </span></h6>
          <div class="progress">
      ...
      <div class="contact-right-wthree">
        <div class="container">
          ...
          <div class="address-w3layouts">
            <p class="para-agileits-w3layouts">Neque porro quisquam est qui dolorem ipsum quia dolor sit amet</p>
            <h4><a href="mailto:info@example.com">info@example.com</a></h4>
            <h6>0 123 456 789</h6>
            <p class="para-agileits-w3layouts">27 Nether Street, Finchley, London N12 7NN, United Kingdom</p>
          </div>
